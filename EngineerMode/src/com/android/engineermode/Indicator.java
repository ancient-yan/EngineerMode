...
public class Indicator extends Activity {
	...
	private final int ID_LED=20101110;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btnLightOn.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
		        ...
		        notification.ledARGB = 0x22334455;  //0xFF0000 is red
		...
		if (id != 0) {
	        ...
	        nm.cancel(ID_LED);
	        nm.notify(ID_LED, notification);
	        new CustomAlertDialog.Builder(Indicator.this)
    		.setTitle2(R.string.auto_test_choose,R.string.test_again,new View.OnClickListener() {
				public void onClick(View v) {
					CommonUtil.autoNextActivity(Indicator.this, db, id);
					finish();
				}
			}).setMessage(R.string.auto_indicator_title)
			.setIcon(android.R.drawable.ic_dialog_info)
			.setPositiveButton(R.string.auto_test_no, new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog,int which) {
					ContentValues values = new ContentValues();
    				values.put(AutoHardwareTest.ITEM, getString(R.string.indicator));
    				...
    				CommonUtil.autoNextActivity(Indicator.this, db, id+1);
					nm.cancel(ID_LED);
					finish();
				}
