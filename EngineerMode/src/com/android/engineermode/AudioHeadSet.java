...
public class AudioHeadSet extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		myButton1.setOnClickListener(new ImageButton.OnClickListener() {
			public void onClick(View arg0) {
				try {
					if (!sdCardExit) {
						Toast.makeText(AudioHeadSet.this, getString(R.string.audio_sd_info),Toast.LENGTH_LONG).show();
						return;
					}
		...
		if (id!=0){
			if(!CommonUtil.hasSd()){
				...
				values.put(AutoHardwareTest.ITEM, getString(R.string.auto_audio_head_res_title));
				...
				CommonUtil.autoNextActivity(AudioHeadSet.this, db, id+1);
				finish();
				return;
			}
			myButton1.setEnabled(false);
			...
			myListView1.setEnabled(false);
			try {
				new AlertDialog.Builder(AudioHeadSet.this).setTitle(
						R.string.auto_audio_title_in).setMessage(
    ...
    Handler handler = new Handler(){   
        ...
        public void handleMessage(Message msg) {   
            ...
            case 3:
              	timer3.cancel();
				try {
					new CustomAlertDialog.Builder(AudioHeadSet.this)
					.setTitle2(R.string.auto_test_choose,R.string.test_again,new View.OnClickListener() {
						public void onClick(View v) {
							CommonUtil.autoNextActivity(AudioHeadSet.this, db, id);
							finish();
						}
					}).setMessage(
							R.string.auto_audio_head_res_info).setIcon(
							android.R.drawable.ic_dialog_info)
